...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across NCSC guidance documents. Covers Cyber Essentials, 10 Steps to Cyber Security, Cyber Assessment Framework (CAF), board-level guidance, and technical publications.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Get a specific NCSC guidance document by reference (e.g., 'NCSC-CE-2024', 'NCSC-CAF-3.2').",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description:
      "Search NCSC security advisories and alerts. Returns advisories with severity, affected products, and CVE references.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Get a specific NCSC security advisory by reference (e.g., 'NCSC-ADV-2024-001').",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "NCSC advisory reference" },
      },
      required: ["reference"],
    },
  },
